...
function SendgridInstall($module) {
    ...
    msv_set_config("sendgrid_user", "", true, "*", "Username to connect to api.sendgrid.com", "system");
    msv_set_config("sendgrid_password", "", true, "*", "Password to connect to api.sendgrid.com", "system");
